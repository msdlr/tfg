...
contract General_test {
    ...
    function beforeAll() public {
        ...
        testContract = new GeneralContract(msg.sender);
    }
    ...
    function checkFirstAdmin() public {
        ...
        Assert.equal(testContract.checkAdmin(msg.sender),true,"caller was not made admin");
        Assert.equal(testContract.checkRegistered(msg.sender),false,"caller is not on the user list");
    }
    
    function addUser() public {
        
        // Check that this user is not registered 
